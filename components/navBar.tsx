...
const protectedNavItems = [
  { name: "Competitions", href: "/Dashboard", newTab: true, icon: TrophyIcon },
];
...
const DockNavbar = () => {
  ...
  const isAuthenticated = isLoaded && !!userId; // Check if the user is signed in
                    ...
                    <TooltipTrigger asChild>
                      <Link
                        ...
                        className={cn(
                          ...
                          "size-12 rounded-full opacity-90 hover:opacity-100 transition"
                        )}
                      >
            ...
            <div>
              {isAuthenticated ? (
                ...
                <SignInButton mode="modal">
                  <button className="text-white font-Tomorrow bg-primary rounded-full px-5 py-2 mt-8 hover:bg-opacity-80 transition">
                    Sign In
                  </button>
                </SignInButton>
              )}
